...
const Index = () => {
  ...
  return (
    <MainLayout>
      ...
      <section className="py-12 md:py-32 bg-gradient-to-b from-blue-50/50 to-white relative">
        <div className="container-custom px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-8 relative">
            ...
            <h1 className="text-3xl lg:text-6xl tracking-tight mb-4 md:mb-6 text-theme-black font-bold md:text-5xl px-4 md:px-0">Jeder Moment hat seinen Film.
Wir finden ihn für dich!</h1>
            <p className="text-base md:text-xl text-gray-600 mb-6 font-thin px-4 md:px-0">Entdecke Filmempfehlungen, die zu deinem Tag, deiner Laune, deinem Leben passen.</p>
          </div>
          <HomeFilterBox />
          ...
          {customLists.length > 0 && (
            <div className="mt-8">
              {customLists.map(list => (
                <div key={list.id} className="bg-white/80 backdrop-blur-sm p-4 md:p-6 rounded-2xl shadow-lg border border-gray-100 mb-4">
