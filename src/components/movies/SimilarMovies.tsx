      ...
      <div className="glass-card overflow-hidden rounded-xl p-8">
        {!showRandomMovie ? (
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-[300px,1fr] gap-8 mt-8">
              ...
              <div className="space-y-4">
                <h2 className="text-3xl font-semibold">{randomMovie?.title}</h2>
                {year && <p className="text-lg text-gray-500">{year}</p>}
                <p className="text-gray-600 text-lg leading-relaxed">{randomMovie?.overview}</p>
                <Link to={`/movie/${randomMovie?.id}`}>
                  <Button className="w-fit bg-[#ea384c] text-white hover:bg-[#ea384c]/90 px-8">
